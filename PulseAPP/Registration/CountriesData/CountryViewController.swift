...
//  PulseAPP
//
//  Created by Алексей Поддубный on 26.10.2021.
//
...
class CountryViewController: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "UnwindToRegistration" {
            ...
            countryChosen = dupList[index].extensionCode
        }
    }
    ...
    func configuration() {
        for code in NSLocale.isoCountryCodes  {
            ...
            if name != nil {
                ...
                countriesList.append(model)
            }
        }
        self.dupList = self.countriesList
...
extension CountryViewController : UISearchBarDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    func searchBar(_ searchBar: UISearchBar, textDidChange searchText: String) {
        ...
        self.dupList = searchText.isEmpty ? countriesList : countriesList.filter({ (model) -> Bool in
